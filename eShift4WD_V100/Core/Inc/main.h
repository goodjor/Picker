...
#define FILTER_N 									101 
#define Default_Proportion_Value 	10  //比例系数1.0
#define Default_Control_Pressure 	250 //25Mp
#define Default_Filter_Len				10
#define Channel_1 								1

//封装EEPROM地址
#define Addr_Control_Pressure 0x00
#define Addr_Proportion_Value 0x10
