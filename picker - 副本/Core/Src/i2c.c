...
{	
	...
	HAL_Delay(10);
	AT24C02_WriteLenByte(Addr_Hieght_value,Default_Height_Value,1);
	HAL_Delay(10);
	AT24C02_WriteLenByte(Addr_Sensitivity,Default_Sensitivity,1);
	HAL_Delay(10);
	AT24C02_WriteLenByte(Addr_Rapidity,Default_Rapidity,1);
	HAL_Delay(10);
	AT24C02_WriteLenByte(Addr_PWM_Value_Up,Default_PWM_Value_Up,2);
	HAL_Delay(10);
	AT24C02_WriteLenByte(Addr_PWM_Value_Down,Default_PWM_Value_Down,2);
	HAL_Delay(10);
	
	AT24C02_WriteLenByte(Addr_Left1_Min,Default_Height_Min,2);
	HAL_Delay(10);
	AT24C02_WriteLenByte(Addr_Left1_Max,Default_Height_Max,2);
	HAL_Delay(10);
	AT24C02_WriteLenByte(Addr_Right1_Min,Default_Height_Min,2);
	HAL_Delay(10);	
	AT24C02_WriteLenByte(Addr_Right1_Max,Default_Height_Max,2);
	HAL_Delay(10);	
	#if Model_Switch
	AT24C02_WriteLenByte(Addr_Left2_Min,Default_Height_Min,2);
	HAL_Delay(10);
	AT24C02_WriteLenByte(Addr_Left2_Max,Default_Height_Max,2);
	HAL_Delay(10);
	AT24C02_WriteLenByte(Addr_Right2_Min,Default_Height_Min,2);
	HAL_Delay(10);	
	AT24C02_WriteLenByte(Addr_Right2_Max,Default_Height_Max,2);
	HAL_Delay(10);	
	#endif
}
void Read_EEPROM(void)
{
	...
	data_storage.Height_Value = AT24C02_ReadLenByte(Addr_Hieght_value,1);
	HAL_Delay(10);
	...
	data_storage.Picker_Set.Left1_Min = AT24C02_ReadLenByte(Addr_Left1_Min,2);
	HAL_Delay(10);
	data_storage.Picker_Set.Left1_Max = AT24C02_ReadLenByte(Addr_Left1_Max,2);
	HAL_Delay(10);
	data_storage.Picker_Set.Right1_Min = AT24C02_ReadLenByte(Addr_Right1_Min,2);
	HAL_Delay(10);
	data_storage.Picker_Set.Right1_Max = AT24C02_ReadLenByte(Addr_Right1_Max,2);
	HAL_Delay(10);
	#if Model_Switch	
	data_storage.Picker_Set.Left2_Min = AT24C02_ReadLenByte(Addr_Left2_Min,2);
	HAL_Delay(10);
	data_storage.Picker_Set.Left2_Max = AT24C02_ReadLenByte(Addr_Left2_Min,2);
	HAL_Delay(10);
	data_storage.Picker_Set.Right2_Min = AT24C02_ReadLenByte(Addr_Right2_Min,2);
	HAL_Delay(10);
	data_storage.Picker_Set.Right2_Max = AT24C02_ReadLenByte(Addr_Right2_Min,2);
	HAL_Delay(10);
	#endif
